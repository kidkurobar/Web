    ...
    <div className="min-h-screen bg-[#F5F5F5] relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto px-4 py-20 text-center">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-16 relative">
          {[
            { label: 'Line', sub: 'แชทกับเรา', icon: <MessageCircle size={24} />, href: 'https://line.me/YOUR_LINE_ID', color: '#E63022' },
            { label: 'Messenger', sub: 'ส่งข้อความ', icon: <MessageCircle size={24} />, href: 'https://m.me/YOUR_PAGE', color: '#F97316' },
            { label: 'โทรศัพท์', sub: 'โทรหาเรา', icon: <Phone size={24} />, href: 'tel:+66XXXXXXXXX', color: '#E63022' },
          ].map((c) => (
            <a
              key={c.label}
              href={c.href}
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm text-left max-w-sm mx-auto">
          ...
          <p className="text-gray-400 text-sm pl-7">info@sourcing8.com</p>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-r from-[#E63022] to-[#F97316] py-14 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="https://line.me/YOUR_LINE_ID" target="_blank" rel="noopener noreferrer" className="btn-outline flex items-center justify-center gap-2">
            <MessageCircle size={18} />
            Line
          </a>
          <a href="tel:+66XXXXXXXXX" className="btn-outline flex items-center justify-center gap-2">
            <Phone size={18} />
            โทรศัพท์
          </a>
        </div>
