...
const faqs = [
  {
    ...
    a: 'การสั่งซื้อขั้นต่ำ (MOQ) ของเราจะแตกต่างกันไปตามประเภทของสินค้า โดยส่วนใหญ่จะเริ่มต้นที่ 50-100 ชิ้น </ br>อย่างไรก็ตาม สินค้าบางรายการอาจมีจำนวนสั่งซื้อขั้นต่ำที่ยืดหยุ่นกว่านั้น คุณสามารถติดต่อทีมงานของเราเพื่อสอบถามรายละเอียดเพิ่มเติมสำหรับสินค้าที่คุณสนใจได้เลยค่ะ',
  },
  {
