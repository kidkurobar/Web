...
const nfcCard: Product = {
  ...
  slug: 'nfc-card',
  name: 'การ์ด NFC',
  pageTitle: 'การ์ด NFC พิมพ์โลโก้แบรนด์ ขั้นต่ำน้อย ราคาโรงงาน',
  pageSubtitle: 'รับผลิตการ์ด NFC พิมพ์โลโก้ทุกประเภท แตะเพื่อแชร์ข้อมูลได้ทันที สั่งขั้นต่ำ 100 ใบ ราคาโรงงาน',
